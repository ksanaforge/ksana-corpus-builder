 ...
 */
var NormalizeDiacritics = function () {
  function NormalizeDiacritics() {
    _classCallCheck(this, NormalizeDiacritics);
  }

  _createClass(NormalizeDiacritics, null, [{
    key: 'normalize',
    ...
    value: function normalize() {
      ...
      if (typeof str !== 'string') {
        throw new TypeError('Invalid type ' + (typeof str === 'undefined' ? 'undefined' : _typeof(str)) + '. Only value of type String is allowed');
      }

      var diacritics = NormalizeDiacritics.diacritics;
      var diacriticsLen = diacritics.length;
      var normalized = str;

      for (var i = 0; i < diacriticsLen; i += 1) {
